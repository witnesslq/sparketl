...
/**
  ...
  */
private[unionpay] trait JdbcConnection {
  ...
  def properties(driver: String): Properties = {
    ...
    //批量插入的数据大小
    properties.put("batchsize", "30000")
...
private[unionpay] object MysqlConnection {
...
private[unionpay] object Db2Connection {
